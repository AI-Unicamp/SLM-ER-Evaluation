...
INPUT_WAV_DIR="<PATH TO GENERATED SAMPLES>/samples_f5tts/7_ref_SERtestSet_F5" # Example directory with WAVs
OUTPUT_CSV_PATH="${PROJECT_ROOT}/inferences/f5_7_ref.csv" # Path to save the CSV results
