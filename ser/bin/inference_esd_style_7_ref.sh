...
#SBATCH --output=slurm/emotion2vec_esd_infer_%j.out # Standard output file
#SBATCH --error=slurm/emotion2vec_esd_infer_%j.err   # Standard error file
...
# Infer on a directory of WAV files and save results to CSV
INPUT_WAV_DIR="<PATH TO GENERATED SAMPLES>/samples_styletts2/7_ref_SERtestSet" # Example directory with WAVs
OUTPUT_CSV_PATH="${PROJECT_ROOT}/inferences/style_7_ref.csv" # Path to save the CSV results
