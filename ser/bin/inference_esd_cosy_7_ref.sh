...
INPUT_WAV_DIR="<PATH TO GENERATED SAMPLES>/samples_cosyvoice/7_ref/audio" # Example directory with WAVs
OUTPUT_CSV_PATH="${PROJECT_ROOT}/inferences/cosy_7_ref.csv" # Path to save the CSV results
