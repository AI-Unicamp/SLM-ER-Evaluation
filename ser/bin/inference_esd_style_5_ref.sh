...
INPUT_WAV_DIR="<PATH TO GENERATED SAMPLES>/samples_styletts2/5_ref/audio" # Example directory with WAVs
OUTPUT_CSV_PATH="${PROJECT_ROOT}/inferences/style_5_ref.csv" # Path to save the CSV results
